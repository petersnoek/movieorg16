...
namespace ConsoleExampleTMDBLib
{
    class Program
    {
        static void Main(string[] args)
        {
            // start by installing (tools -> nuget package manager -> manage nuget packages for solution
            // -> browse -> enter "json" -> install NewtonSoft.JSON
            // -> browse -> enter ""tmdblib -> install TMDBLib

            // now find sample application at https://github.com/LordMike/TMDbLib/blob/master/TestApplication/Program.cs 
